  ...
  return (
      ...
      <div className="about-page">
        <div className="vid-container">
              <video className="bg-video" src={vd2} autoPlay muted loop>
              </video>
            ...
            <div className="container d-flex justify-content-center align-items-center min-vh-100">
              ...
              <div className="card shadow-lg" style={{ width: "100%", height: "370px" }}>
              <h2 className="title fw-bold">About Us</h2>
                <p className="text-justify mt-2">
                    We opened during the pandemic and we started providing clean and safe
                    water to our community. Slowly, we were able to help small businesses
                    have their quality  water as well. We gained our customer&apos;s 
                    trust and loyalty. We are grateful for everyone who has supported us, 
                    we&apos;ll continue to provide the best quality water.
                </p>
              </div>
              </div>
            </div>
